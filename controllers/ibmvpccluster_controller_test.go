...
var _ = Describe("IBMVPCClusterReconciler", func() {
	BeforeEach(func() {})
	AfterEach(func() {})

	Context("Reconcile an IBMVPCCluster", func() {
		It("should not error and not requeue the request with insufficient set up", func() {
			...
			instance := &infrav1.IBMVPCCluster{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
