...
var _ = Describe("IBMVPCMachineReconciler", func() {
	BeforeEach(func() {})
	AfterEach(func() {})

	Context("Reconcile an IBMVPCMachine", func() {
		It("should not error with minimal set up", func() {
			...
			instance := &infrav1.IBMVPCMachine{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
